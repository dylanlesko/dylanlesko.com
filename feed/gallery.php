...
function get_db_results() {
	global $conn;
	$_query = sprintf("SELECT SQL_CALC_FOUND_ROWS * FROM vgalery ORDER BY galid DESC LIMIT %d,%d", SmartyPaginate::getCurrentIndex(),SmartyPaginate::getLimit());
...
SmartyPaginate::setUrl('gallery.php');
...
@$next = (int)$_GET['next'];
$smarty->display('gallery.php',$next);
