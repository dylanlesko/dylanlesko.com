...
function get_db_results() {
	global $conn;
	$_query = sprintf("SELECT SQL_CALC_FOUND_ROWS * FROM tubevideo ORDER BY yuid DESC LIMIT %d,%d",
...
SmartyPaginate::setLimit(35);
SmartyPaginate::setUrl('video.php');
...
@$next = (int)$_GET['next'];
$smarty->display('video.php',$next);
$smarty->display('videocc.php');
$arecordSet->Close();
$conn->Close();
######################################
##video.php                   4.1.4.##
