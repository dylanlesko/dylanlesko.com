...
if(@$_GET["page"] != ""):
	...
	$strSQL = "SELECT * FROM tubereview ORDER BY yrevid DESC";
	...
	if(!$rs->EOF) {
		...
		while(!$rs->EOF) {
		echo $rs->fields['yctexte'] . "&nbsp;&nbsp;<a href=\"javascript:gotos('deletemedia.php?id=".$rs->fields['yrevid']."')\"><br /><font color='red'>Delete Comment</font></a><br /><br />";
                $rs->moveNext();
		}
