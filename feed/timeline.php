...
function get_db_results() {
	global $conn;
	$_query = sprintf('SELECT SQL_CALC_FOUND_ROWS * FROM publictime order by commid desc LIMIT %d,%d',
...
SmartyPaginate::setUrl('timeline.php');
...
@$next = (int)$_GET['next'];
$smarty->display('timeline.php',$next);
